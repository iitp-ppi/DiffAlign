...
class GINEncoder(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, num_convs=3, activation='relu', short_cut=True, concat_hidden=False):
        ...
        # self.time_embdder = torch.nn.linear(1,hidden_channels)
    ...
    def forward(self, z, edge_index, edge_attr):
        ...
        # note_attr = note_attr + self.time_embdder(time)
...
class GINEncoder2(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, num_convs=3, activation='relu', short_cut=True, concat_hidden=False):
        ...
        self.short_cut = short_cut
        self.concat_hidden = concat_hidden
        self.node_emb = nn.Linear(128, hidden_dim)
